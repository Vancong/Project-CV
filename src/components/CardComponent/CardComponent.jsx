...
const CardComponent = () => {
  return (
    <Card
            ...
            cover={<img alt="example"  style={ {height:"220px",objectFit:"cover"}} src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" />}
        >
       ...
       <div>
            <p className='product_title'>Monoi</p>
            <p className='product_description'>Monotheme</p>
            <p className='product_price'>{Fomater(850000)}</p>
       </div>
    </Card>
